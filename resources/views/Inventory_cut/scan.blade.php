	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-5 col-md-offset-4">
			<div class="panel panel-default">
				<div class="panel-head ing" style="background-color: #ff0c0c63"><b>Scan SU (Subotica fab)</b>
						@if (isset($msg))
				...
				{!! Form::open(['url' => 'insert_temp_su_cut']) !!}
				...
				@if(isset($data))
				@foreach ($data as $d)
				{!! Form::open(['url' => 'update_su_cut/'.$d->id]) !!}
				...
				<br>			
				<div>
					<a href="{{ url('inventory_stop_cut') }}" class="btn btn-danger">Stop Inventory</a>
					<a href="{{ url('inventory_cancel_cut') }}" class="btn btn-warning">Cancel last SU</a>
				</div>
				<br>
