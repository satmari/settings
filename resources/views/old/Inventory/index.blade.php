	...
	<div class="row vertical-center-row">
		<div class="text-center">
			<div class="panel panel-default">
				<div class="panel-heading">SAP Inventory table</div>

				
					<a href="{{ url('import_inventory') }}" class="btn btn-info btn-xs ">Import inventory database</a>
					<a href="{{ url('inventory_scan') }}" class="btn btn-success btn-xs ">Inventory scan</a>
                ...
                -->
				    ...
				    @foreach ($data as $d)
				        ...
				        <tr>
				        	...
				        	{{--<td>
				        	@if(Auth::check())
				        	  	<a href="{{ url('#/'.$d->id) }}" class="btn btn-info btn-xs center-block">Edit</a>
				        	@endif
				        	</td>--}}
						</tr>
