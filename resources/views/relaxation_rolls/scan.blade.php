	...
	<div class="row vertical-center-row">
		<div class="text-center">
			<div class="panel panel-default">
				...
				{!! Form::open(['url' => 'insert_relaxation_roll']) !!}
				...
				@if(isset($data))
					...
					<table class="table" style="background-color: #9fd9dc29">
						...
						<tr>
							...
							<td>{{ $d->batch }}</td>
							<td>{{ round($d->qty,2) }}</td>
							<td><a href="{{ url('remove_relaxation_roll/'.$d->id.'/'.$d->ses) }}" class="btn btn-xs btn-danger">X</a> </td>
				...
				<div>
					...
					@if (isset($session))
					{!! Form::open(['url' => 'confirm_relaxation_roll']) !!}
