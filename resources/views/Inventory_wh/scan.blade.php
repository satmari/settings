	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-5 col-md-offset-4">
			<div class="panel panel-default">
				<div class="panel-head ing" style="background-color: #fff1d5"><b>Scan SU (Subotica acc)</b>
						@if (isset($msg))
				...
				{!! Form::open(['url' => 'insert_temp_su_wh']) !!}
				...
				@if(isset($data))
				@foreach ($data as $d)
				{!! Form::open(['url' => 'update_su_wh/'.$d->id]) !!}
				...
				<br>			
				<div>
					<a href="{{ url('inventory_stop_wh') }}" class="btn btn-danger">Stop Inventory</a>
					<a href="{{ url('inventory_cancel_wh') }}" class="btn btn-warning">Cancel last SU</a>
				</div>
				<br>
