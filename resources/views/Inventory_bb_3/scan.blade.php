	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-5 col-md-offset-4">
			<div class="panel panel-default">
				<div class="panel-head ing" style="background-color: #03202e63"><b>Scan SU BB3 (Kikinda all)</b>
						@if (isset($msg))
				...
				{!! Form::open(['url' => 'insert_temp_su_bb_3']) !!}
				...
				@if(isset($data))
				@foreach ($data as $d)
				{!! Form::open(['url' => 'update_su_bb_3/'.$d->id]) !!}
				...
				<br>			
				<div>
					<a href="{{ url('inventory_stop_bb_3') }}" class="btn btn-danger">Stop Inventory</a>
					<a href="{{ url('inventory_cancel_bb_3') }}" class="btn btn-warning">Cancel last SU</a>
				</div>
				<br>
