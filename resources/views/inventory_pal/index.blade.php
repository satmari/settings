	...
	<div class="row vertical-center-row">
		<div class="text-center">
			<div class="panel panel-default">
				<div class="panel-heading">SAP Inventory table (SU PAL)</div>

			
					<a href="{{ url('import_inventory_pal') }}" class="btn btn-info btn-xs ">Import inventory database</a>
					<a href="{{ url('inventory_scan_pal') }}" class="btn btn-success btn-xs ">Inventory scan</a>
