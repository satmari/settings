	...
	<div class="row">
		<div class="text-center col-md-4 col-md-offset-4">
			<div class="panel panel-default">
				...
				<br>
				<div class="panel panel-default">
					<a href="{{url('/inventory_bb')}}" class="btn btn-default center-block"  style="background-color: #0c35ffb5">SAP Inventory BB1</a>
				</div>
				<br>
				<div class="panel panel-default">
					<a href="{{url('/inventory_bb_2')}}" class="btn btn-default center-block"  style="background-color: #0cb0ff63">SAP Inventory BB2</a>
				</div>
