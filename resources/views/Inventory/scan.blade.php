	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-5 col-md-offset-4">
			<div class="panel panel-default">
				<div class="panel-head ing" style="background-color: #80808029"><b>Scan SU (Main)</b>
						@if (isset($msg))
				...
				<br>			
				<div>
					<a href="{{ url('inventory_stop') }}" class="btn btn-danger">Stop Inventory</a>
					<a href="{{ url('inventory_cancel') }}" class="btn btn-warning">Cancel last SU</a>
				</div>
				<br>
