    ...
    <div class="row vertical-center-row">
        <div class="text-center col-md-6 col-md-offset-3">
            ...
            <div class="panel panel-default">
                ...
                {!! Form::open(['url' => 'locker_ki_edit_post']) !!}
                ...
                <div class="panel-body">
                    <a href="{{ url('remove_k_employee/'.$id) }}" class="btn btn-danger btn center-bl ock">Remove employee</a>
                </div>

                <div class="panel-body">
                    <div class="">
                        <a href="{{url('/lockers_ki')}}" class="btn btn-default center-block">Back</a>
                    </div>
                </div>
