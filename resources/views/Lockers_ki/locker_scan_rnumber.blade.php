	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-6 col-md-offset-3">
			...
			<div class="panel panel-default">
				<div class="panel-head ing" style="background-color: yellow"><b>Choose locker number and location for employee: <span style="color:red"> {{ $employee }} </span></b>
				...
				{!! Form::open(['url' => 'locker_ki_scan_locker']) !!}
					...
					<p>Locker place: </p>
						<!-- <select name="place" class="cho sen narrow-chosen" required>
		               	...
		               	{!! Form::select('place', array(''=>'','ZENSKA SVLACIONICA'=>'ZENSKA SVLACIONICA','MUSKA SVLACIONICA'=>'MUSKA SVLACIONICA'), '', array('class' => 'form-control','required'=>'required')); !!} 
					</p>
