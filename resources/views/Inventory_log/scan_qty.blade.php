	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-5 col-md-offset-4">
			<div class="panel panel-default">
				...
				{!! Form::open(['url' => 'inventory_issue_qty']) !!}

				{!! Form::hidden('su', $data[0]->su, ['class' => 'form-control']) !!}
				{!! Form::hidden('su_new_location', $su_new_location, ['class' => 'form-control']) !!}
				

				<table class="tab le">
					<tr>
						<td>Insert qty to issue &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</td>
						<td>{!! Form::input('number', 'issue_qty', round($data[0]->sum_qty,3), ['class' => 'form-con trol','step' => '0.001', 'autofocus' => 'autofocus']) !!} </td>
					</tr>
				</table>

				<div class="panel-body">
					{!! Form::submit('Confirm issue', ['class' => 'btn btn-danger center-block']) !!}
				</div>
