	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-5 col-md-offset-4">
			<div class="panel panel-default">
				<div class="panel-head ing" style="background-color: #0c35ffb5"><b>Scan SU BB1 (Subotica Stock)</b>
						@if (isset($msg))
				...
				{!! Form::open(['url' => 'insert_temp_su_bb']) !!}
				...
				@if(isset($data))
				@foreach ($data as $d)
				{!! Form::open(['url' => 'update_su_bb/'.$d->id]) !!}
				...
				<br>			
				<div>
					<a href="{{ url('inventory_stop_bb') }}" class="btn btn-danger">Stop Inventory</a>
					<a href="{{ url('inventory_cancel_bb') }}" class="btn btn-warning">Cancel last SU</a>
				</div>
				<br>
