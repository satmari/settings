    ...
    <div class="row vertical-center-row">
        <div class="text-center col-md-4 col-md-offset-4">
            <div class="panel panel-default">
				<div class="panel-heading">Machines to transfer from SUBOTICA TO KIKINDA</div>
				<br>
					{!! Form::open(['method'=>'POST', 'url'=>'/transferg_k']) !!}
					...
					@foreach($osarray as $array)
						<tr>
							...
							<td>
					   		...
					   		<td>
					   			@if($key == 'os')
					   			<a href="{{url('/transferg_k_delete/'.$value )}}" class="btn btn-danger btn-xs">X</a>
					   			@endif
					   		</td>
				...
				<hr>
				{!! Form::open(['url' => 'transferg_k_post']) !!}
