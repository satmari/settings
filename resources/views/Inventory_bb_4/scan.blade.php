	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-5 col-md-offset-4">
			<div class="panel panel-default">
				<div class="panel-head ing" style="background-color: #6e432463"><b>Scan SU BB4 (Senta all)</b>
						@if (isset($msg))
				...
				{!! Form::open(['url' => 'insert_temp_su_bb_4']) !!}
				...
				@if(isset($data))
				@foreach ($data as $d)
				{!! Form::open(['url' => 'update_su_bb_4/'.$d->id]) !!}
				...
				<br>			
				<div>
					<a href="{{ url('inventory_stop_bb_4') }}" class="btn btn-danger">Stop Inventory</a>
					<a href="{{ url('inventory_cancel_bb_4') }}" class="btn btn-warning">Cancel last SU</a>
				</div>
				<br>
