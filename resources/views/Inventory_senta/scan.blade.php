	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-5 col-md-offset-4">
			<div class="panel panel-default">
				...
				{!! Form::open(['url' => 'insert_temp_su_senta']) !!}
				...
				@if(isset($data))
				@foreach ($data as $d)
				{!! Form::open(['url' => 'update_su_senta/'.$d->id]) !!}
				...
				<br>			
				<div>
					<a href="{{ url('inventory_stop_senta') }}" class="btn btn-danger">Stop Inventory</a>
					<a href="{{ url('inventory_cancel_senta') }}" class="btn btn-warning">Cancel last SU</a>
				</div>
				<br>
