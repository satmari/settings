	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-5 col-md-offset-4">
			<div class="panel panel-default">
				...
				{!! Form::open(['url' => 'inventory_bintoloc_post_loc']) !!}
					{!! Form::hidden('bin', $bin, ['class' => 'form-control']) !!}
					<table class="tab le">
					<tr>
						<td>Location &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</td>
						<td>{!! Form::text('location', null, ['class' => 'fo rm-control','autofocus' => 'autofocus']) !!}</td>
					</tr>
